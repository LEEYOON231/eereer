...
export function About() {
  ...
  const defaultInfo = {
    ...
    background: {"image":"/uploads/about-background-1765148322093.webp","video":"","color":"","opacity":0.2},
    experienceCards: [{"icon":"graduation","title":"대원고등학교","period":"2017 ~ 2020","description":""},{"icon":"graduation","title":"단국대학교","period":"2021 - 현재","description":"도시계획부동산학부"},{"icon":"building","title":"법무법인 코러스","period":"2024.06 ~ 2024.08 ","description":"부동산 소유권 이전 및 저당권 말소"},{"icon":"graduation","title":"단국대학교 부동산 학술동아리 '유리드'","period":"2024.01 ~ 2024.12","description":"임원진"},{"icon":"graduation","title":"단국대학교 총학생회 '유월'","period":"2025.03 ~2025.12","description":"대외협력국 차장"},{"icon":"building","title":"43기 신한은행 홍보대사","period":"2025.08 ~ 2025.12","description":"서경강 8팀"}],
    ...
    storyTitle: "나의 이야기",
    story: ["어떤 일이든 시작도 전에 겁먹고 완벽한 계획만을 세우려다 기회를 놓치는 경우가 많다고 생각합니다. 하지만 해왔던 경험은, 그것이 성공이든 실패든, 가장 확실한 자산이 됩니다. 특히 처음 마주하는 생소한 업무나 복잡해 보이는 과제일수록 이 말을 되새기며, \"일단 해보자\"는 용기를 냅니다.\n  ","물론 실패를 두려워하지 않는 것은 아닙니다. 하지만 저에게 실패는 끝이 아니라 가장 확실한 배움의 과정입니다. 부딪혀보지 않으면 무엇이 문제인지, 무엇을 보완해야 하는지조차 알 수 없습니다. 실패의 경험을 통해 부족한 점을 냉철하게 분석하고, 다음에는 더 나은 방향을 찾을 수 있기 때문입니다.","이러한 가치관은 저에게 긍정적인 끈기를 가르쳐 줬습니다. '안 된다'는 생각보다 '어떻게 하면 되게 할까?'를 먼저 고민하게 되었습니다. 포기하지 않고 될 때까지 시도하는 이 태도, 어떤 어려움에 부딪혀도 결국 해답을 찾아내는 이 원동력으로, 앞으로 마주할 모든 도전을 성장의 기회로 만들어 가겠습니다.\n"],
    storyImage: "/uploads/about-image-1765006572954.png",
    hobbies: ["🎨 전시회 관람하기","✈️ 여행","⛳ 골프"]
  }
