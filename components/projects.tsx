...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    initialDisplay: 12,
    loadMoreCount: 12,
    background: {"image":"/uploads/projects-background-1765148862594.jpeg","video":"","color":"","opacity":0.4},
    projects: [{"image":"/uploads/project-0-1765004212977.png","video":"","title":"UNIQUERS X 신대홍 사업계획서","description":"이 사업계획서는 국내 펫코노미의 급성장에도 불구하고 부족한 '펫 금융과 헬스 융합' 시장의 공백을 해소하기 위한 AI 기반 펫 포트폴리오 뱅킹 서비스인 'My Pet Bank(마이 펫 뱅크)'를 제안"},{"image":"/uploads/project-1-1765004219607.png","video":"","title":"경매 물건 보고서","description":"본 보고서는 경기도 수원시 영통구 매탄동 임광아파트(사건번호 2023 타경 84047)에 대한 경매 물건 분석 자료"},{"image":"/uploads/project-1765003876929-1765003877119.png","video":"","title":"수안동 주상복합 개발사업 캐시플로우","description":"부산 수안구 동래동에 위치한 주상복합에 대해 총 매출, 토지/공사비 등의 비용, PF 대출 조건 및 이자 비용을 상세히 분석하여 프로젝트의 예상 수익성과 주요 재무 지표(LTV 등)를 분석"},{"image":"/uploads/project-1765004056577-1765004056753.png","video":"","title":"유리드 개발IM","description":"부산시 동래구 수안동 주상복합 개발사업(PF)에 대한 Information Memorandum(투자설명서)"},{"image":"/uploads/project-1765004991075-1765004991691.png","video":"","title":"신한은행 마케팅 활동","description":"트렌드를 반영한 콘텐츠를 직접 기획·제작하여 신한은행의 브랜드 이미지를 젊고 친근하게 제고하고 있습니다. 해당 영상 외에도 다양한 영상 및 카드뉴스(54개) 제작"},{"image":"/uploads/project-1765005819784-1765005820414.png","video":"","title":"삼성전자 인사전략 및 제안점","description":"삼성전자 MX사업부의 조직개편안에 대한 캡스톤디자인 보고서로, 기업 개요, 시장 분석, 경쟁 전략, 직무 분석 등을 포함"},{"image":"/uploads/project-1765147796441-1765147796535.png","video":"","title":"한국토지신탁 ","description":"한국토지신탁의 전반적인 회사 소개와 안동 용산동 488에 대한 개발사업 분석 및 신탁원부 분석"},{"image":"/uploads/project-1765147943618-1765147943628.png","video":"","title":"신한알파리츠 마케팅 전략","description":"전체적인 리츠 사업에 대한 분석과 그 중 신한알파리츠에서 진행하고 있는 리츠 사업에 대해 알아보며 해당 리츠에 관한 마케팅 전략 분석"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
